...
Public static portfolio site. Visitor-facing README content stays public.

Career content and site shells are generated by the private sibling `career`
constructor. Career facts live in its `CAREER_SOT_PRIVATE.md`; output wording
...
`full-resume.html`, or the single `assets/Max_Vilchevskiy_Senior_iOS_Engineer.pdf`.
